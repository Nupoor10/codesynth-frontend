    ...
    <div>
      ...
      <div className='home__page__content'>
        ...
        <div className='home__page__cards'>
          ...
          text={"Step into your personal code haven, a place where your ingenious code creations, aka 'codes' thrive. Here, you can manage your existing pears and craft fresh code playgrounds effortlessly."}
          path ={"/mycodes"}/>
        </div>
      </div>
      </div>
